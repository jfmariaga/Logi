...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('pagina_web/assets/css/main.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('pagina_web/assets/css/style_p.css') }}">
...
<body class="horizontal-layout horizontal-menu 2-columns  menu-expanded pace-done light-theme menu-hide" data-open="click" data-menu="horizontal-menu" data-col="2-columns">
    ...
    <script src="{{ asset('modernadmin/app-assets/vendors/js/ui/jquery.sticky.js') }}" type="text/javascript"></script>
