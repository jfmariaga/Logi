<div x-data="gestion_documental" 
x-on:file-uploaded.window="isDragging = false"
class="position-relative min-vh-50">
    ...
    <div x-show="isDragging" 
         ...
         class="position-fixed fixed-top fixed-bottom"
         style="z-index: 1050; background-color: rgba(0, 123, 255, 0.2); backdrop-filter: blur(2px);">
        <div class="d-flex align-items-center justify-content-center h-100">
            <div class="bg-white rounded-lg shadow-lg p-5 border border-2 border-dashed border-primary" style="border-radius:20px;">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div x-show="$wire.uploadedFiles.length > 0" class="card">
                            <div class="row">
                                ...
                                {{-- buscar documento --}}
                                <div class="col-md-4">
                                    <input x-model="search" type="text" class="form-control" placeholder="Buscar documento...">
                                </div>
                            </div>
                                    ...
                                    <div :class="`item_file_${file.id}`" class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <!-- Icono según tipo -->
                                                <div class="mr-3">
                                                    <div :class="getIcon( file.mime_type ).bgClass" class="rounded p-1 text-white">
                                                        <i :class="getIcon( file.mime_type ).faIcon" class="fa-lg text-white" style="font-size:40px;"></i>
                                                    </div>
                                                </div>
                                                
                                                <!-- Información del archivo -->
                                                <div class="text-justify">
                                                    <div class="font-weight-bold text-dark text-decoration-none hover-text-primary">
                                            ...
                                            <div class="btn-group" role="group">
                                                <div class="d-flex">
                                                    ...
                                                    <a x-show="getIcon( file.mime_type ).icon == 'image' || getIcon( file.mime_type ).icon == 'pdf'" :href="file.url" data-fancybox class=" border_none btn btn-sm grey btn-outline-secondary " style="padding: 3px;"> 
                                                        <i class="la la-eye"></i>
                                                    </a>      
                                                    ...
                                                    <a :href="file.url" :download="file.original_name" class=" border_none btn btn-sm grey btn-outline-secondary " style="padding: 3px;"> 
                                                        <i class="la la-download"></i>
                                                    </a>                                                                                                
                                                    <a href="javascript:" x-on:click="confirmDelete( file )" class=" border_none btn btn-sm grey btn-outline-danger " style="padding: 3px;"> 
            ...
            Alpine.data('gestion_documental', () => ({
                ...
                get filterFiles(){
                    ...
                    if( this.search.length > 0 ){
                        ...
                        data = __duplicar( @this.uploadedFiles ).filter( ( i ) => i.original_name.trim().toLowerCase().includes( this.search ) )
                    }else{
                    ...
                    alertClickCallback('Eliminar',
                        ...
                        'warning', 'Continuar', 'Cancelar', async () => {
                            ...
                            if (res) {
                                ...
                                @this.uploadedFiles = __duplicar( @this.uploadedFiles ).filter( ( i ) => i.id != file.id )
