    ...
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                @can('crear información de interes')
                ...
                <div class="card">
                    <template x-for="nota in $wire.notas" :key="nota.id">
                        <div :class="`bs-callout-${nota.tipo}`" class="callout-border-left mt-1 p-1 lh-1">
                            ...
                            <div class="italic_sub">Expira el: <span x-text="__formatDate( nota.fecha_expired )"></span>
                            </div>
                            <div class="italic_sub">Destinatarios: <span
                                    x-text="nota.rol ? nota.rol.name : 'Todos'"></span> </div>

                            <div class="d-flex lh-1">
                                <p x-text="nota.descripcion" class="lh-1 mt-1"></p>

                                <div style="margin-left:auto;min-width:80px;">
                                    @can('editar información de interes')
                                        <a href="javascript:" x-on:click="editNota(nota)"
                                            class="border_none btn btn-sm grey btn-outline-secondary" style="padding: 3px;">
                                            <i class="la la-edit"></i>
                                        </a>
                                    @endcan
                                    @can('eliminar información de interes')
                                        <a href="javascript:" x-on:click="confirmDeleteNota(nota.id)"
                                            class="border_none btn btn-sm grey btn-outline-secondary" style="padding: 3px;">
